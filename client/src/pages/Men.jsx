...
const Men = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const { data } = await axios.get(`/api/products?category=men&keyword=${keyword}&pageSize=100`);
        ...
        <div className="min-h-screen bg-white pb-20">
            <div className="bg-primary py-20 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold tracking-tighter mb-4">Men's Fashion</h1>
                    <p className="text-gray-300 max-w-2xl mx-auto">Discover the latest trends in men's apparel, from sharp formals to relaxed casuals.</p>
                </div>
            </div>
