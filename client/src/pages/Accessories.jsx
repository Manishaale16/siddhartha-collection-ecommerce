...
const Accessories = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const { data } = await axios.get(`/api/products?category=accessories&keyword=${keyword}&pageSize=100`);
    ...
    return (
        <div className="min-h-screen bg-white pb-20">
            <div className="bg-[#f2f4fd] py-20 text-primary">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h4 className="text-accent text-sm font-bold uppercase tracking-[0.3em] mb-4">Collection</h4>
                    <h1 className="text-5xl md:text-6xl font-bold tracking-tighter mb-4">Accessories</h1>
                    <p className="text-gray-600 max-w-2xl mx-auto">The perfect finishing touch for any outfit. Explore our collection of premium watches, bags, and more.</p>
                </div>
            </div>
